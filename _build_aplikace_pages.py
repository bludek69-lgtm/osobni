...
DL_APPS = [
    ...
    {"icon": "🍱", "color": "#e2722e", "version": "0.8.5",
     "name": "Meal Planner", "file": "MealPlanner-v0.8.5-Setup.exe",
    ...
    {"icon": "🧳", "color": "#1a9c5b", "version": "0.7.5",
     "name": "Italia Travel Planner", "file": "ItaliaTravel-v0.7.5-Setup.exe",
    ...
    {"icon": "🪙", "color": "#9b59b6", "version": "1.1.4",
     "name": "Collection", "file": "Collection-v1.1.4-Setup.exe",
